    ...
    return (
      React.createElement("div", {className: "ui basic dropdown labeled search icon button"}, 
        ...
        React.createElement("div", {className: "menu"}, 
          React.createElement("div", {className: "item", "data-value": "{this.state.data.cca2}"}, React.createElement("i", {className: "{this.state.data.cca2} flag"}), this.state.data.capital)
